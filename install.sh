...
brew install helix zellij zoxide direnv sd fnm pure \
  eza bat fd dust bottom procs ripgrep git-delta difftastic lazygit gnupg pinentry-mac \
  gh withgraphite/tap/graphite zsh-autosuggestions zsh-syntax-highlighting
